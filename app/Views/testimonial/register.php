            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="it-newsletter-2-left">
                        <h4 class="it-newsletter-2-title text-white mb-0">Segera daftar dan <br> jadilah yang berikutnya!</h4>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="it-newsletter-input-box">
                        <a href="<?= base_url('pendaftaran'); ?>" class="it-btn-yellow white-bg">
                            <span>
                                <span class="text-1">Daftar SPMB</span>
                                <span class="text-2">Daftar SPMB</span>
                            </span>
                            <i>
