        ...
        <div class="it-course-tab-content">
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                    <div class="row gx-35">
                        <?php foreach ($ekskuls as $eskul) : ?>
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="it-course-item mb-35">
                                <div class="it-course-thumb z-index-1 border-radius-20">
                                    <a href="courses-details-v3.html"><img class="w-100" src="<?= base_url('assets/img/ekskul/' . $eskul['image']); ?>" alt="<?= $eskul['image'] ?? 'course-1-1.jpg'; ?>" alt=""></a>
                                    <span class="course-category"><?= ucfirst($eskul['category']) ?></span>
                                ...
                                <div class="it-course-content p-relative">
                                    ...
                                    <h5 class="it-course-title mb-20"><a class="border-line" href="courses-details-v3.html"><?= $eskul['name']; ?></a></h5>
                                    <div class="it-course-rating mb-10">
                                        <div>
                                            
                                            <span><?= $eskul['description']; ?></span>
                                        </div>
                                    </div>
                                    <div class="it-course-meta d-flex justify-content-between">
                                        <span>
                                            <i class="fa-regular fa-chalkboard-user"></i>
                                            <?= $eskul['teacher']; ?> Pembimbing
                                        </span>
                                        <span>
                                            <i class="fa-sharp fa-solid fa-graduation-cap"></i>
                                            <?= $eskul['students']; ?> Siswa
                                        </span>
                                    </div>
