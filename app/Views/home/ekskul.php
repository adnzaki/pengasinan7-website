                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="it-course-item mb-35">
                                    <div class="it-course-thumb z-index-1 border-radius-20">
                                        <img class="w-100" src="<?= base_url('assets/img/ekskul/' . $eskul['image']); ?>" alt="<?= $eskul['image'] ?? 'course-1-1.jpg'; ?>" alt="Gambar <?= $eskul['name']; ?>">
                                    ...
                                    <div class="it-course-content p-relative">
                                        ...
                                        <h5 class="it-course-title mb-20"><a class="border-line" href="#"><?= $eskul['name']; ?></a></h5>
