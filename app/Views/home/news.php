                    ...
                    <div class="it-blog-2-item mb-35">
                        <div class="it-blog-thumb p-relative">
                            <!-- <img class="w-100" src="<? //= base_url('assets/img/blog/blog-3-1.jpg'); 
                                                            ?>" alt=""> -->
                            <a href="<?= $post->url ?>">
                                <img class="w-100" style="height: 270px; object-fit: cover;" src="<?= $post->media ?>" alt="">
                            </a>
                        </div>
                        <div class="it-blog-2-content z-index-2">
                            ...
                            <h5 class="it-blog-title mb-15">
                                <a class="border-line" href="blog-details-left-sidebar.html"><?= $post->title ?></a>
                            </h5>
