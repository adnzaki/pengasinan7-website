...
<section class="it-testimonial-area z-index-1 pt-130 pb-130">
    <img class="it-testimonial-shape-3" src="<?= base_url('assets/img/shape/testimonial-1-2.png'); ?>" alt="">
    <img class="it-testimonial-shape-6" src="<?= base_url('assets/img/shape/testimonial-1-3.png'); ?>" alt="">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="it-testimonial-section-title-box text-center mb-70">
                    <span class="it-section-subtitle">
                        ...
                        Kesan Alumni</span>
                    <h4 class="it-section-title">Apa Kata Mereka tentang<br> SDN Pengasinan VII</h4>
                </div>
            </div>
        </div>
