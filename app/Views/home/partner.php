...
<div class="it-brand-3-area gray-bg z-index-1 pt-130 pb-180">
    <img class="it-brand-3-shape-1 d-none d-xl-block" src="<?= base_url('assets/img/shape/brand-3-1.png'); ?>" alt="">
    <div class="container">
        <div class="row">
                ...
                <div class="it-brand-3-left">
                    <div class="it-brand-section-title-box mb-35">
                        <span class="it-section-subtitle">
                            ...
                            Mitra Pendidikan</span>
                        <h4 class="it-section-title">Senantiasa bersinergi <br>dengan mitra terbaik <br>dalam bidang pendidikan</h4>
                    </div>
                    <div class="it-brand-btn">
                        <a href="#" class="it-btn-yellow theme-bg border-radius-100">
                            <span>
                                <span class="text-1">Lihat Selengkapnya</span>
                                <span class="text-2">Lihat Selengkapnya</span>
                            </span>
                            <i>
