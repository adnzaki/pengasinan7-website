...
<section class="it-blog-2-area z-index-1 pt-130 pb-130 fix">
    <img class="it-blog-shape-1" src="<?= base_url('assets/img/shape/blog-3-1.png'); ?>" alt="">
    <img class="it-blog-shape-2 d-none d-lg-block" data-parallax='{"x": 200, "smoothness": 30}' src="<?= base_url('assets/img/shape/blog-1-2.png'); ?>" alt="">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="row gx-35">
            <div class="col-xl-4 col-lg-6 col-md-6 wow itfadeUp" data-wow-duration=".9s"
                ...
                <div class="it-blog-2-item mb-35">
                    <div class="it-blog-thumb p-relative">
                        <img class="w-100" src="<?= base_url('assets/img/blog/blog-3-1.jpg'); ?>" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow itfadeUp" data-wow-duration=".9s"
                ...
                <div class="it-blog-2-item mb-35">
                    <div class="it-blog-thumb p-relative">
                        <img class="w-100" src="<?= base_url('assets/img/blog/blog-3-2.jpg'); ?>" alt="">
                    </div>
                    <div class="it-blog-2-content z-index-2">
                        <div class="it-blog-meta mb-25">
                            <span>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow itfadeUp" data-wow-duration=".9s"
                ...
                <div class="it-blog-2-item mb-35">
                    <div class="it-blog-thumb p-relative">
                        <img class="w-100" src="<?= base_url('assets/img/blog/blog-3-3.jpg'); ?>" alt="">
                    </div>
                    <div class="it-blog-2-content z-index-2">
                        <div class="it-blog-meta mb-25">
                            <span>
...
<!-- <div class="it-newsletter-area it-newsletter-style-2">
    <div class="container">
        <div class="it-newsletter-wrap theme-bg z-index-2 wow itfadeUp" data-wow-duration=".9s"
            data-wow-delay=".3s">
            <img class="it-newsletter-shape-1" src="<?//= base_url('assets/img/shape/newsletter-2-1.png'); ?>" alt="">
