            ...
            <div class="row gx-35">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="it-shop-sidebar">
                        <?= view('single-post/search-box') ?>

                        <!-- post -->
                        <div class="sidebar-widget mb-60">
                            <h4 class="sidebar-widget-title mb-25">Berita terbaru</h4>
                                            ...
                                            <li>
                                                <div class="rc-post">
                                                    <div class="rc-post-thumb mb-20">
                                                        <a href="<?= $recent->url ?>">
                                                            <img src="<?= $recent->singlePostImage ?>" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="rc-post-content">
                                                        <div class="rc-meta mb-10">
                                                            <span>
                                                                ...
                                                                <?= osdate()->create($recent->date, 'd-M-y') ?>
                                                            </span>
                                                        </div>
                                                        <h5 class="rc-post-title">
                                                            <a class="border-line" href="<?= $recent->url ?>"><?= $recent->title ?></a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </li>
