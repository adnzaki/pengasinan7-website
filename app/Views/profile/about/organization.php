<div class="row">
    <div class="col-12">
        <div class="it-choose-2-section-title-box text-center mb-60 ">
            <a class="organization-btn" href="<?= base_url('assets/img/about/organization/struktur.png') ?>" data-fancybox="gallery" data-caption="Struktur Organisasi">
                <img class="mb-5" src="<?= base_url('assets/img/about/organization/struktur.png') ?>" alt="Struktur Organisasi" />
            </a>
                ...
                <div class="postbox-thumb-box mb-60">
                    ...
                    <div class="postbox-content-box">
                        ...
                        <div class="postbox-dsc">
                            <img src="<?= base_url('assets/img/about/organization/struktur.png') ?>" class="img-fluid" alt="Struktur Organisasi">
                        </div>
