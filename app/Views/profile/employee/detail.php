            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="it-breadcrumb-content z-index-1">
                    <div class="it-breadcrumb-list-2">
                        ...
                        <span><a href="<?= base_url('profil') . ($employee['type'] === 'teacher' ? '/pendidik' : '/tenaga-kependidikan') ?>"><?= $employee['type'] === 'teacher' ? 'Pendidik' : 'Tenaga Kependidikan'; ?></a></span>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="it-team-details-left mt-55">
                    ...
                    <div class="postbox-dsc">
                        <p class="mb-15 testimonial-text"><?= $employee['description']; ?></p>
                    </div>
                </div>
            </div>
